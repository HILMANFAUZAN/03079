...
<div class="container-fluid px-2 px-md-4">
    <div class="page-header min-height-200 border-radius-xl mt-4" style="background-image: url('<?= baseurl; ?>/assets/img/peaky/1 (4).jpg');">
        ...
        <div class="card card-body mx-3 mx-md-4 mt-n6">
            ...
            <div class="container-audio">
                <audio controls  loop autoplay>
                        <source src="<?= baseurl; ?>/assets/audio/peaky blinders.mp3" type="audio/mpeg">
                </audio>
            </div>
            <div class="container-audio">
