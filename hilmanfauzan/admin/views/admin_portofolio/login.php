...
<body class="bg-info-200">
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('<?= baseurl ?>/assets/img/peaky/1 (4).jpg');">
          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-dark shadow-info border-radius-lg py-3 pe-1">
                  <a href="<?= baseurl;?>">
              ...
              <div class="card-body">
                <form action="" method="POST" class="text-start">
                  ...
                  <div class="text-center">
                    <button type="submit" name="login" class="btn bg-dark w-100 my-4 mb-2 text-white">Sign in</button>
                  </div>
                </form>
              </div>
            </div>
