...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= baseurl; ?>/assets/img/ma.png">
  <title>
    Personalsite
  </title>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <?php foreach($a as $us): ?>
          <img src="<?= baseurl; ?>/assets/img/<?= $us['foto'];?>" class=" border-radius-lg shadow-sm" alt="main_logo">
        <?php endforeach;?>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info" href="?menu=Dashboard">
